// to view the path, upload Pedro4BallBlue.pp into https://visualizer.pedropathing.com/
...
public class Pedro4Ball extends LinearOpMode {
    @IgnoreConfigurable
    ...
    */
    ...
    private void buildPaths() {
        ...
        grab_c1 = robot.follower.pathBuilder()
                .addPath(new BezierCurve(Robot.farScorePose, row1ApproachControlPoint, row1ApproachPose))
        ...
        score_c1 = robot.follower.pathBuilder()
                .addPath(new BezierLine(grab_c1_Pose, Robot.farScorePose))
                .setLinearHeadingInterpolation(grab_c1_Pose.getHeading(), Robot.farScorePose.getHeading())
                .build();

        moveToLever = robot.follower.pathBuilder()
                .addPath(new Path(new BezierLine(Robot.farScorePose, leverPose)))
                .setLinearHeadingInterpolation(Robot.farScorePose.getHeading(), leverPose.getHeading())
                .build();
    }

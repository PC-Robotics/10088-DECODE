...
public class PedroCloseSideAuto extends LinearOpMode {
    ...
    */
    ...
    private static Pose startPose = new Pose(21, 123, Math.toRadians(324));
    ...
    private static Pose row2ApproachControlPoint = new Pose(60, 60);
    ...
    private static Pose row1ApproachControlPoint = new Pose(60, 36);
    ...
    private void mirrorPoses() {
        ...
        if (Robot.alliance == Alliance.RED) {
            ...
            row2ApproachControlPoint = row2ApproachControlPoint.mirror();
            row1ApproachPose = row1ApproachPose.mirror();
    ...
    private void buildPaths() {
        ...
        grab_b2 = robot.follower.pathBuilder()
                .addPath(new BezierCurve(Robot.closeScorePose, row2ApproachPose, row2ApproachControlPoint))
        ...
        grab_b1 = robot.follower.pathBuilder()
                .addPath(new BezierCurve(Robot.closeScorePose, row1ApproachPose, row1ApproachControlPoint))
